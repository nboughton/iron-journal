<template>
  <q-expansion-item class="q-px-sm" header-class="q-px-none q-py-none" :default-opened="open" expand-icon-toggle>
    <template v-slot:header class="row full-width q-gutter-sm">
